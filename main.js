(function () {
    ...
    var textArea1 = document.querySelector('#description');
    var textArea3 = document.querySelector('#ingredients');
    var textArea4 = document.querySelector('#steps');
    ...
    function validate() {
        ...
        if (currentStep === 0) {
            ...
            if (textArea1.value.length < 20 || textArea1.value.length > 255) {
                textArea1.parentElement.dataset.error = 'Required';
                textArea1.parentElement.classList.add('is-error');
                valid = false;
            };
            ...
            if (textArea3.value.length > 255) {
                textArea3.parentElement.dataset.error = 'Required';
                textArea3.parentElement.classList.add('is-error');
                valid = false;
            };             
        } else if (currentStep === 3) {
            if (textArea4.value.length > 255) {
                textArea4.parentElement.dataset.error = 'Required';
                textArea4.parentElement.classList.add('is-error');
                valid = false;
            }             
        }
